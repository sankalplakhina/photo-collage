...
var e,n=t(this);n.data("ui-tooltip-open")&&(e=t.Event("blur"),e.target=e.currentTarget=this,i.close(e,!0)),n.attr("title")&&(n.uniqueId(),i.parents[this.id]={element:this,title:n.attr("title")},n.attr("title",""))}),this._registerCloseHandlers(e,n),this._updateContent(n,e))},_updateContent:function(t,e){var i,n=this.options.content,s=this,o=e?e.type:null;return"string"==typeof n?this._open(e,t,n):(i=n.call(t[0],function(i){s._delay(function(){t.data("ui-tooltip-open")&&(e&&(e.type=o),this._open(e,t,i))})}),void(i&&this._open(e,t,i)))},_open:function(e,i,n){function s(t){h.of=t,r.is(":hidden")||r.position(h)}var o,r,a,l,h=t.extend({},this.options.position);if(n){if(o=this._find(i))return void o.tooltip.find(".ui-tooltip-content").html(n);i.is("[title]")&&(e&&"mouseover"===e.type?i.attr("title",""):i.removeAttr("title")),o=this._tooltip(i),r=o.tooltip,this._addDescribedBy(i,r.attr("id")),r.find(".ui-tooltip-content").html(n),this.liveRegion.children().hide(),n.clone?(l=n.clone(),l.removeAttr("id").find("[id]").removeAttr("id")):l=n,t("<div>").html(l).appendTo(this.liveRegion),this.options.track&&e&&/^mouse/.test(e.type)?(this._on(this.document,{mousemove:s}),s(e)):r.position(t.extend({of:i},this.options.position)),r.hide(),this._show(r,this.options.show),this.options.show&&this.options.show.delay&&(a=this.delayedShow=setInterval(function(){r.is(":visible")&&(s(h.of),clearInterval(a))},t.fx.interval)),this._trigger("open",e,{tooltip:r})}},_registerCloseHandlers:function(e,i){var n={keyup:function(e){if(e.keyCode===t.ui.keyCode.ESCAPE){var n=t.Event(e);n.currentTarget=i[0],this.close(n,!0)}}};i[0]!==this.element[0]&&(n.remove=function(){this._removeTooltip(this._find(i).tooltip)}),e&&"mouseover"!==e.type||(n.mouseleave="close"),e&&"focusin"!==e.type||(n.focusout="close"),this._on(!0,i,n)},close:function(e){var i,n=this,s=t(e?e.currentTarget:this.element),o=this._find(s);return o?(i=o.tooltip,void(o.closing||(clearInterval(this.delayedShow),s.data("ui-tooltip-title")&&!s.attr("title")&&s.attr("title",s.data("ui-tooltip-title")),this._removeDescribedBy(s),o.hiding=!0,i.stop(!0),this._hide(i,this.options.hide,function(){n._removeTooltip(t(this))}),s.removeData("ui-tooltip-open"),this._off(s,"mouseleave focusout keyup"),s[0]!==this.element[0]&&this._off(s,"remove"),this._off(this.document,"mousemove"),e&&"mouseleave"===e.type&&t.each(this.parents,function(e,i){t(i.element).attr("title",i.title),delete n.parents[e]}),o.closing=!0,this._trigger("close",e,{tooltip:i}),o.hiding||(o.closing=!1)))):void s.removeData("ui-tooltip-open")},_tooltip:function(e){var i=t("<div>").attr("role","tooltip").addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content "+(this.options.tooltipClass||"")),n=i.uniqueId().attr("id");return t("<div>").addClass("ui-tooltip-content").appendTo(i),i.appendTo(this.document[0].body),this.tooltips[n]={element:e,tooltip:i}},_find:function(t){var e=t.data("ui-tooltip-id");return e?this.tooltips[e]:null},_removeTooltip:function(t){t.remove(),delete this.tooltips[t.attr("id")]},_destroy:function(){var e=this;t.each(this.tooltips,function(i,n){var s=t.Event("blur"),o=n.element;s.target=s.currentTarget=o[0],e.close(s,!0),t("#"+i).remove(),o.data("ui-tooltip-title")&&(o.attr("title")||o.attr("title",o.data("ui-tooltip-title")),o.removeData("ui-tooltip-title"))}),this.liveRegion.remove()}})}),function(t,e){t.widget("ui.rotatable",t.ui.mouse,{options:{handle:!1,angle:!1,start:null,rotate:null,stop:null},handle:function(t){return t===e?this.options.handle:void(this.options.handle=t)},angle:function(t){return t===e?this.options.angle:(this.options.angle=t,this.elementCurrentAngle=t,void this.performRotation(this.options.angle))},_create:function(){var e;this.options.handle?e=this.options.handle:(e=t(document.createElement("div")),e.addClass("ui-rotatable-handle")),this.listeners={rotateElement:t.proxy(this.rotateElement,this),startRotate:t.proxy(this.startRotate,this),stopRotate:t.proxy(this.stopRotate,this),wheelRotate:t.proxy(this.wheelRotate,this)},this.element.bind("wheel",this.listeners.wheelRotate),e.draggable({helper:"clone",start:this.dragStart,handle:e}),e.bind("mousedown",this.listeners.startRotate),e.appendTo(this.element),0!=this.options.angle?(this.elementCurrentAngle=this.options.angle,this.performRotation(this.elementCurrentAngle)):this.elementCurrentAngle=0},_destroy:function(){this.element.removeClass("ui-rotatable"),this.element.find(".ui-rotatable-handle").remove()},performRotation:function(t){this.element.css("transform","rotate("+t+"rad)"),this.element.css("-moz-transform","rotate("+t+"rad)"),this.element.css("-webkit-transform","rotate("+t+"rad)"),this.element.css("-o-transform","rotate("+t+"rad)")},getElementOffset:function(){this.performRotation(0);var t=this.element.offset();return this.performRotation(this.elementCurrentAngle),t},getElementCenter:function(){var t=this.getElementOffset(),e=t.left+this.element.width()/2,i=t.top+this.element.height()/2;return Array(e,i)},dragStart:function(t){return this.element?!1:void 0},startRotate:function(e){var i=this.getElementCenter(),n=e.pageX-i[0],s=e.pageY-i[1];return this.mouseStartAngle=Math.atan2(s,n),this.elementStartAngle=this.elementCurrentAngle,this.hasRotated=!1,this._propagate("start",e),t(document).bind("mousemove",this.listeners.rotateElement),t(document).bind("mouseup",this.listeners.stopRotate),!1},rotateElement:function(t){if(!this.element||this.element.disabled)return!1;var e=this.getElementCenter(),i=t.pageX-e[0],n=t.pageY-e[1],s=Math.atan2(n,i),o=s-this.mouseStartAngle+this.elementStartAngle;if(t.shiftKey){var r=15/180*Math.PI;0>o&&(r*=-1),o-=(o+r/2)%r-r/2}this.performRotation(o);var a=this.elementCurrentAngle;return this.elementCurrentAngle=o,this._propagate("rotate",t),a!=o&&(this._trigger("rotate",t,this.ui()),this.hasRotated=!0),!1},stopRotate:function(e){return this.element&&!this.element.disabled?(t(document).unbind("mousemove",this.listeners.rotateElement),t(document).unbind("mouseup",this.listeners.stopRotate),this.elementStopAngle=this.elementCurrentAngle,this.hasRotated&&this._propagate("stop",e),setTimeout(function(){this.element=!1},10),!1):void 0},wheelRotate:function(t){return},_propagate:function(e,i){t.ui.plugin.call(this,e,[i,this.ui()]),"rotate"!==e&&this._trigger(e,i,this.ui())},plugins:{},ui:function(){return{api:this,element:this.element,angle:{start:this.elementStartAngle,current:this.elementCurrentAngle,stop:this.elementStopAngle}}}})}(jQuery),function(){function t(t){return document.getElementById(t)}function e(t){t.stopPropagation(),t.preventDefault(),t.target.className="dragover"==t.type?"hover":""}function i(t){e(t);for(var i,s=t.target.files||t.dataTransfer.files,o=0;i=s[o];o++)n(i)}function n(t){if(0===t.type.indexOf("image")){var e=new FileReader;e.onload=function(t){var e='<img src="'+t.target.result+'" alt="On top of Kozi kopka" width="96" height="72">';a(e)},e.readAsDataURL(t)}else alert("Not an Image file. Please try again by adding an image file.")}function s(){var n=t("fileselect"),s=t("filedrag"),o=t("submitbutton");n.addEventListener("change",i,!1);var r=new XMLHttpRequest;r.upload&&(s.addEventListener("dragover",e,!1),s.addEventListener("dragleave",e,!1),s.addEventListener("drop",i,!1),s.style.display="block",o.style.display="none")}function o(){$(".wrapper-div").rotatable("disable"),$(".wrapper-div").find(".ui-rotatable-handle").hide(),$(".wrapper-div").removeClass("ui-selected"),$(".wrapper-div").addClass("ui-resizable-autohide")}function r(t){t.fadeOut(function(){a(t.remove().html())})}function a(t){var e=$(c.find("li")[0]).clone();e.html(t).appendTo(c).fadeIn(),u()}function l(){var t=[];return $.each($(".wrapper-div"),function(e,i){var n=$(i).attr("style");n&&t.push(Number(n.split("z-index: ")[1].split(";")[0]))}),Math.max.apply(null,t)}function h(t){t.fadeOut(function(){var e=$('<div class="wrapper-div" title="Click to select, double click to deselect this image."></div>');e.zIndex(l()+1).append(t.find("img")).appendTo(d).fadeIn().draggable({containment:d,stack:e,cursor:"move"}).resizable({animate:!0,containment:d,maxHeight:300,maxWidth:300,ghost:!0,aspectRatio:!1,handles:"ne, se, sw, nw",autoHide:!1}).rotatable().on("click",function(){$(this).zIndex()<=l()&&$(this).zIndex(l()+1),o(),$(this).rotatable("disable"),$(this).find(".ui-rotatable-handle").show(),$(this).addClass("ui-selected"),$(this).removeClass("ui-resizable-autohide")}).on("dblclick",function(){o(),$(this).addClass("ui-resizable-autohide")}),o()})}function u(){$("li",c).draggable({revert:"invalid",containment:"document",helper:"clone",cursor:"move"}),d.droppable({accept:"#gallery > li",activeClass:"ui-state-highlight",drop:function(t,e){h(e.draggable)}}),c.droppable({accept:"#workspace li",activeClass:"custom-state-active",drop:function(t,e){r(e.draggable)}})}window.File&&window.FileList&&window.FileReader&&s();var c=$("#gallery"),d=$("#workspace");u(),$("html").keyup(function(t){if(46==t.keyCode){var e=$(".ui-selected");e.length>0?r(e):e.length<=0&&alert("Please select an image on Workspace to delete.")}})}();